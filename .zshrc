...
alias dev='ssh -t akosbeke@archlinux.loc "bash -l -c '\''tmux a || tmux'\''"'
...
alias q-coverage="open /Volumes/archshare/Lingoda/lingoda/quiz-engine/ddd/coverage/index.html"
...
alias lt-generate="(cd $LINGODA_PATH/lingoda/linguando && php bin/console bazinga:js-translation:dump ../workspaces/packages/translations/src --pattern=/{domain}.{_format} --merge-domains --format=js)"
